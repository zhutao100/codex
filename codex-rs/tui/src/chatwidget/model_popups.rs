//! Model and reasoning-effort popup helpers for ChatWidget.
...
impl ChatWidget {
    ...
    pub(super) fn picker_visible_model_presets(presets: Vec<ModelPreset>) -> Vec<ModelPreset> {
        presets
            .into_iter()
    ...
    pub(super) fn model_shortcut_choices(
        current_model: &str,

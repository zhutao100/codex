...
Implemented with two rollout findings: pre-turn auto-compaction must also capture notes, and pending input must be deferred until after compaction so notes capture is not short-circuited.

Prepare a drop-in design for carrying forward structured session work notes before auto-compaction.

## Target Base

This plan is written against code shape `fe8b474acd43cb8894d661944c6b5c8db0ef0ad1`.
